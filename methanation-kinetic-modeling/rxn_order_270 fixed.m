%% Assumptions made: steady state, constant pressure
% Evaluated at T=270 +/-3 C
x = [0.02114, 0.01854, 0.01359, 0.01114,0.00865 ];  % Cao
y_exp = [0.746452223, 0.736785329, 0.726269316, 0.728904847,0.734104046]; % Ca/Cao
...
%% Function to calculate SSE, used to see the error for the data
...
%% Function to calculate RMSE to measure error between predicted and actual values
...
xlabel('C_{A0}'); 
ylabel('C_{A}/C_{A0}'); 
title('Reaction Order Model Fit at 270 C'); 
