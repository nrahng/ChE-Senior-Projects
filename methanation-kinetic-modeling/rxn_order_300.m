% Evaluated at T=300 C
x = [0.01646, 0.01454, 0.01077, 0.0088, 0.00694];  % Cao
y_exp = [0.665856622, 0.663686382,0.658310121, 0.681818182,0.691642651]; % Ca/Cao
...
xlabel('C_{A0}'); 
ylabel('C_{A}/C_{A0}'); 
title('Reaction Order Model Fit at 300 C'); 
